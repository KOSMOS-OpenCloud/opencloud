...
type Config struct {
	...
	TransferSecret                string              `yaml:"transfer_secret" env:"OC_TRANSFER_SECRET" desc:"The storage transfer secret." introductionVersion:"6.1.0"`
	TransferTimeout               time.Duration       `yaml:"transfer_timeout" env:"PROXY_TRANSFER_TIMEOUT" desc:"The storage transfer timeout." introductionVersion:"6.1.0"`
